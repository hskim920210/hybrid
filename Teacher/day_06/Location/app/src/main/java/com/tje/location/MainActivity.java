    ...
    private void setMapLongClickEvent() {
        ...
        map.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
            ...
            public void onMapLongClick(LatLng latLng) {
                ...
                markerOptions.icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.nougat_36));
    ...
    private void getRoute(final LatLng endPoint) {
        ...
        fusedLocationProviderClient.getLastLocation().addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                ...
                GoogleRouteApi googleRouteApi = new GoogleRouteApi(
                        MainActivity.this,
                        startPoint, endPoint, new GoogleRouteApi.EventListener() {
                    @Override
                    public void onApiResult(String result) {
                        Toast.makeText(
                                MainActivity.this,
                                "요청 성공", Toast.LENGTH_LONG).show();
                    }
