            ...
            public void onClick(View view) {
                ...
                AsyncTask.execute(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String targetURL =
                                "/request_get" + (param != null ? param : "");

                        try {
                            URL endPoint =
                                    new URL(MainActivity.HOST_NETWORK_PROTOCOL +
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            if( connection.getResponseCode() == HttpURLConnection.HTTP_OK ) {
                                ...
                                final String login_result =
                                        element.getAsJsonObject().get("result").getAsString();
                                final String login_msg =
                                        element.getAsJsonObject().get("login_msg").getAsString();;
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            if( connection.getResponseCode() == HttpURLConnection.HTTP_OK ) {
                                ...
                                JsonParser parser = new JsonParser();
                                JsonElement element = parser.parse(in);
                                final String logout_result =
                                        element.getAsJsonObject().get("result").getAsString();
                                final String logout_msg =
                                        element.getAsJsonObject().get("logout_msg").getAsString();;
